 ...
 *  @version 1.0
 */
# define START_RTL_NS namespace LazRTL {
...
typedef  int8_t  LazSHORTINT;
typedef uint16_t LazWORD;
typedef uint32_t LazCARDINAL;
typedef  int32_t LazLONGINT;
typedef uint32_t LazLONGWORD;
